                ...
                <ul class="nk-menu">
                        ...
                        if (intval(get_option( 'marketking_enable_announcements_setting', 1 )) === 1){
                            if(marketking()->vendor_has_panel('announcements')){
                                ...
                                <li class="nk-menu-item">
                                    <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true)
        )).'announcements';?>" class="nk-menu-link">
                    ...
                    if ($show_announ === 'no'){
                        ...
                        <li class="nk-menu-item marketking_menu_hidden_item">
                                <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'announcements';?>" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-bell"></em></span>
                                    <span class="nk-menu-text"><?php esc_html_e('Announcements', 'marketking-multivendor-marketplace-for-woocommerce');?></span>
                                    <?php if ($unread_ann !== 0){ ?>
                                        <span class="nk-menu-badge badge-danger"><?php echo esc_html($unread_ann).esc_html__(' New', 'marketking-multivendor-marketplace-for-woocommerce');?></span>
                    ...
                    if(marketking()->vendor_has_panel('dashboard')){
                        ?>
                        <li class="nk-menu-item">
                           <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true)));?>" class="nk-menu-link">
                    ...
                    if (defined('MARKETKINGPRO_DIR')){
                        if (intval(get_option( 'marketking_enable_messages_setting', 1 )) === 1){
                            if(marketking()->vendor_has_panel('messages')){
                                ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'messages';?>" class="nk-menu-link">
                    ...
                    if (defined('MARKETKINGPRO_DIR')){
                        if (intval(get_option( 'marketking_enable_coupons_setting', 1 )) === 1){
                            if(marketking()->vendor_has_panel('coupons')){
                                ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'coupons';?>" class="nk-menu-link">
                    ...
                    if(marketking()->vendor_has_panel('products')){
                        ?>
                        <li class="nk-menu-item">
                            <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'products';?>" class="nk-menu-link" data-original-title="" title="">
                    ...
                    if (intval(get_option( 'marketking_agents_can_manage_orders_setting', 1 )) === 1){
                        if(marketking()->vendor_has_panel('orders')){
                            ?>
                            <li class="nk-menu-item">
                                <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'orders';?>" class="nk-menu-link" data-original-title="" title="">
                    ...
                    if (defined('B2BKING_DIR') && defined('MARKETKINGPRO_DIR') && intval(get_option('marketking_enable_b2bkingintegration_setting', 1)) === 1){
                        ...
                        if (intval(get_option('b2bking_enable_offers_setting', 1)) === 1){
                            if(marketking()->vendor_has_panel('b2bkingoffers')){
                                ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'offers';?>" class="nk-menu-link" data-original-title="" title="">
                        ...
                        if (intval(get_option('b2bking_enable_conversations_setting', 1)) === 1){
                            if(marketking()->vendor_has_panel('b2bkingconversations')){
                               ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'b2bmessaging';?>" class="nk-menu-link" data-original-title="" title="">
                        ...
                        if (intval(get_option('b2bking_show_dynamic_rules_vendors_setting_marketking', 1)) === 1){
                            if(marketking()->vendor_has_panel('b2bkingrules')){
                                ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'rules';?>" class="nk-menu-link" data-original-title="" title="">
                    ...
                    if (defined('MARKETKINGPRO_DIR')){
                        if (intval(get_option( 'marketking_enable_teams_setting', 1 )) === 1){
                            if(marketking()->vendor_has_panel('teams')){
                                ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true)    )).'team';?>" class="nk-menu-link">
                    ...
                    if (defined('MARKETKINGPRO_DIR')){
                        if (intval(get_option( 'marketking_enable_earnings_setting', 1 )) === 1){
                            if(marketking()->vendor_has_panel('earnings')){
                                ...
                                ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'earnings';?>" class="nk-menu-link">
                    ...
                    if (intval(get_option( 'marketking_enable_payouts_setting', 1 )) === 1){
                        if(marketking()->vendor_has_panel('payouts')){
                            ?>
                            <li class="nk-menu-item">
                                <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'payouts';?>" class="nk-menu-link">
                    ...
                    if (defined('MARKETKINGPRO_DIR')){
                        if (intval(get_option( 'marketking_enable_reviews_setting', 1 )) === 1){
                            if(marketking()->vendor_has_panel('reviews')){
                                ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'reviews';?>" class="nk-menu-link">
                        ...
                        if (intval(get_option( 'marketking_enable_refunds_setting', 1 )) === 1){
                            if(marketking()->vendor_has_panel('refunds')){
                                ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'refunds';?>" class="nk-menu-link">
                        ...
                        if (intval(get_option( 'marketking_enable_vendordocs_setting', 1 )) === 1){
                            if(marketking()->vendor_has_panel('vendordocs')){
                                ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'docs';?>" class="nk-menu-link">
                        ...
                        if (intval(get_option( 'marketking_enable_memberships_setting', 1 )) === 1){
                            if(marketking()->vendor_has_panel('memberships')){
                                ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'membership';?>" class="nk-menu-link">
