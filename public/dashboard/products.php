                                                    ...
                                                    if (!marketking()->is_vendor_team_member() || $checkedval === 1){
                                                        if(marketking()->vendor_can_add_more_products($user_id)){
                                                            ...
                                                            <li class="nk-block-tools-opt">
                                                                <a href="<?php echo esc_attr(get_page_link(get_option( 'marketking_vendordash_page_setting', 'disabled' )).'edit-product/add');?>" class="btn btn-primary d-md-inline-flex"><em class="icon ni ni-plus"></em><span><?php esc_html_e('Add Product','marketking-multivendor-marketplace-for-woocommerce'); ?></span></a>
                                                            </li>
                                                            <?php
                                                        } else {
                                        ...
                                        if (defined('MARKETKINGPRO_DIR')){
                                            if (intval(get_option('marketking_enable_importexport_setting', 1)) === 1){
                                                ...
                                                <div class="marketking_importexport_buttons_container">
                                                            ...
                                                            if(marketking()->vendor_can_add_more_products($user_id)){
                                                                ...
                                                                if (!marketking()->is_vendor_team_member()){
                                                                    ?>
                                                                        ...
                                                                        <a href="<?php echo esc_attr(get_page_link(get_option( 'marketking_vendordash_page_setting', 'disabled' )).'import-products');?>" class="btn btn-sm btn-secondary d-none d-md-inline-flex"><em class="icon ni ni-upload"></em><span><?php esc_html_e('Import','marketking-multivendor-marketplace-for-woocommerce'); ?></span></a>
                                                    ...
                                                    // export option
                                                    ?>
                                                    <a href="<?php echo esc_attr(get_page_link(get_option( 'marketking_vendordash_page_setting', 'disabled' )).'export-products');?>" class="btn btn-sm btn-secondary d-none d-md-inline-flex"><em class="icon ni ni-download"></em><span><?php esc_html_e('Export','marketking-multivendor-marketplace-for-woocommerce'); ?></span></a>
                                                    <?php
                                                ?>
                                                </div>
                                                <?php
                    ...
                    <table id="marketking_dashboard_products_table" class="nk-tb-list is-separate mb-3">
                        <thead>
                            <tr class="nk-tb-item nk-tb-head">
                                ...
                                <th class="nk-tb-col tb-col-md marketking-column-min"><span class="sub-text"><?php esc_html_e('Actions','marketking-multivendor-marketplace-for-woocommerce'); ?></span></th>                           
                                ...
                                foreach ($vendor_products as $product){
                                    ...
                                    <tr class="nk-tb-item">
                                        <td class="nk-tb-col marketking-column-small">
                                            ...
                                            // either not team member, or team member with permission to add
                                            if (!marketking()->is_vendor_team_member() || $checkedval === 1){
                                                echo esc_attr(get_page_link(get_option( 'marketking_vendordash_page_setting', 'disabled' )).'edit-product/'.$product->get_id());
                                            } else {
                                                echo esc_attr(get_page_link(apply_filters( 'wpml_object_id', get_option( 'marketking_vendordash_page_setting', 'disabled' ), 'post' , true))).'products';
                                            }
